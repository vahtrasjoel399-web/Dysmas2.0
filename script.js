...
const translations = {
    et: {
        ...
        about_text: "Dysmas Ehitus on usaldusväärne ehitusettevõte, mis pakub laia valikut ehitus- ja remonttöid üle kogu Eesti. Meie meeskond koosneb kogenud spetsialistidest, kes tagavad iga projekti kõrge kvaliteedi ja tähtaegadest kinnipidamise.",
    ...
    ru: {
        ...
        about_text: "Dysmas Ehitus — надёжная строительная компания, предлагающая широкий спектр строительных и ремонтных работ по всей Эстонии. Наша команда состоит из опытных специалистов, которые гарантируют высокое качество каждого проекта и соблюдение сроков.",
    ...
    en: {
        ...
        about_text: "Dysmas Ehitus is a reliable construction company offering a wide range of construction and renovation services across Estonia. Our team consists of experienced specialists who ensure high quality and adherence to deadlines for every project.",
